package com.example.double_result;
...
/** DoubleResultPlugin */
public class DoubleResultPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel =
        new MethodChannel(registrar.messenger(), "double_result");
    channel.setMethodCallHandler(new DoubleResultPlugin());
  }
